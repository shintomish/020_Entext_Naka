...
class UserController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $organizations  = $this->auth_user_organization();
        ...
        $compacts = compact( 'common_no','users', 'organizations','organization_id' );
    ...
    public function create()
    {
        ...
        $compacts = compact( 'organizations', 'organization','organization_id' );
    ...
    public function edit($id)
    {
        ...
        $compacts = compact( 'organizations', 'organization', 'organization_id','user' );
    ...
    public function serch(User $customer, Request $request)
    {
        ...
        $common_no ='00_1';
        $keyword2  = $keyword;
        $compacts = compact( 'common_no','users', 'organizations','organization_id','keyword2' );
