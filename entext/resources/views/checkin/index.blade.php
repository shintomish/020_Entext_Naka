        ...
        <script type="text/javascript">
            ...
            new Vue({
                ...
                methods: {
                    ...
                    //     .bind('pusher:subscription_succeeded', (member) => {
                    ...
                    .bind('statistics-updated', (data) => {
                            ...
                            // var update = {
                            //     x: [[data.status], [data.status], [data.status]],
                            ...
                            this.chart = Plotly.newPlot('statisticsChart', [update], layout).then(
                                () => {
                                    Plotly.addTraces('statisticsChart', [update]);

                                    // Plotly.extendTraces('statisticsChart', [update]);
                                    console.log('addTraces: ', update);
                                }
                            );
                        });
                    },
                    ...
                    subscribeToTestChannel() {
                        this.pusher.subscribe('TestChannel')
                        .bind('TestEvent', (data) => {
                            // this.logs.push(data);
                            alert(data);
                        });
                        // var pusherChannel = this.pusher.subscribe('TestChannel');

                        // pusherChannel.bind('TestEvent', function(data){
                        //     alert(data.message);
                        // });
                    },
