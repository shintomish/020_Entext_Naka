...
<script>
    new Vue({
        ...
        data: {
            ...
            app: null,
            port: 6001,
            apps: [{"id":"1404791","key":"0ff8809ccd70d39e96f8","secret":"50af2cd4cc7cc48e21e0","name":"Lc_Entext","host":null,"path":null,"capacity":null,"clientMessagesEnabled":false,"statisticsEnabled":true}],
            form: {
                channel: null,
                event: null,
                data: null
        ...
        methods: {
            connect() {
                this.pusher = new Pusher(this.app.key, {
                    ...
                    disableStats: true,
                    authEndpoint: 'http://localhost:8573/laravel-websockets/auth',
                    auth: {
                        headers: {
                            'X-CSRF-Token': "qj0pwH8iyFuJUdz6WfTABx1MLdaUzMb3OdqVBSV9",
            ...
            loadChart() {
                $.getJSON('http://localhost:8573/laravel-websockets/api/' + this.app.id + '/statistics', (data) => {
            ...
            sendEvent() {
                $.post('http://localhost:8573/laravel-websockets/event', {
                    _token: 'qj0pwH8iyFuJUdz6WfTABx1MLdaUzMb3OdqVBSV9',
                    key: this.app.key,
