...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8 order-md-1">
            <form class="needs-validation" novalidate action="{{route('stuff.store')}}" method="POST">
                @csrf
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <input type="text" class="form-control" name="custom_no" value="{{ old('custom_no') }}">
                </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <input type="text" class="form-control" name="last_kana" value="{{ old('last_kana') }}">
                </div>
                ...
                <div class="col-4">
                    <input type="text" class="form-control" name="first_kana" value="{{ old('first_kana') }}">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                <input type="date" class="form-control" name="withdrawaldate" value="{{ old('withdrawaldate') }}">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-4">
                    <input type="date" class="form-control" name="recessdate" value="{{ old('recessdate') }}">
                </div>
