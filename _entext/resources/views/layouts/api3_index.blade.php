...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        {{-- uncaught referenceerror axios is not defined laravel --}}
    ...
    <body>
        <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0 shadow">
            <a class="navbar-brand col-md-3 col-lg-2 me-0 px-3" href="{{ route('client.index') }}">{{ config('app.name', 'Laravel') }}</a>
            ...
            <div class="row">
                <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
                    <div class="position-sticky pt-3">
                        <ul class="nav flex-column">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('stu.index')}}">
                                    <i class="fas fa-user-friends"></i>
                                    生徒管理
                                </a>
                            </li>
                        ...
                        <ul class="nav flex-column mb-2">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('stu-attend.index')}}">
                                    <i class="fas fa-tasks"></i>
                                    生徒出席履歴
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('stuff-attend.index')}}">
                                    <i class="fas fa-tasks"></i>
                                    職員出勤履歴
                                </a>
                            </li>
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                        ...
                        {{-- <form  class="form-inline my-2 my-lg-0 ml-2" action="{{route('stu-attendexport')}}" method="GET">
                            @csrf
                            @method('get')
